...
/**
 * Hashes the schema-parsed blueprint representation used by publication and
 * display. Parsing first fixes field order and strips no data because every
 * blueprint object is strict.
 */
